...
<div class="container-register">
  <div class="wrapper">
    <form 
      ...
      action="/HW3_110705063/models/patient_registration_check.php"
    >    
      <h3 class="form-heading">Patient register</h3>
      <div>
      ...
      <div>
        <p class="label-txt"><b>請輸入性別與血型</b></p>
        <select id="sex">
